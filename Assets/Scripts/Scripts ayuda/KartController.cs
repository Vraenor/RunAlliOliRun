...
public class KartController : MonoBehaviour
{
	...
	public void OnTriggerEnter(Collider other) {
		...
		{ //Is a waypoint
			WaypointNumber waypoint_script = other.gameObject.GetComponent<WaypointNumber> ();
			WaypointNumber lastwaypoint_script = lastWaypoint.GetComponentInParent<WaypointNumber> ();
